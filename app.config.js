  ...
  expo: {
    ...
    ios: {
      ...
      infoPlist: {
        ...
        NSPhotoLibraryAddUsageDescription:
          "This app needs access to save invoice PDFs to your device.",
        NSLocationWhenInUseUsageDescription:
          "We use your location to show nearby services and improve your experience.",
        NSLocationAlwaysAndWhenInUseUsageDescription:
          "We use your location to enhance location-based features.",
      },
    },
    ...
    plugins: [
      ...
      [
        ...
        {
          merchantIdentifier: "merchant.com.fahim.razahomequoto",
      ...
      [
        ...
        {
          photosPermission:
            "Allow Raza Home Quote to access your photos to save invoice PDFs.",
          savePhotosPermission:
            "Allow Raza Home Quote to save invoice PDFs to your device.",
